...
export class addFieldCategoriesProducts1649746238484
  implements MigrationInterface
{
  name = 'addFieldCategoriesProducts1649746238484';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "category" ADD "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(
